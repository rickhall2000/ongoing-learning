...
text = """The city of paris is the capital and most populous city in France. The Eiffel Tower is a famous landmark in Paris"""
triples = chain.invoke(text).content
